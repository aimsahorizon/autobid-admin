...
async function getTransaction(id: string) {
  ...
  const { data, error } = await supabase
    ...
    .select(`
      ...
      seller:users!auction_transactions_seller_id_fkey (id, full_name, email, profile_photo_url, profile_image_url),
      buyer:users!auction_transactions_buyer_id_fkey (id, full_name, email, profile_photo_url, profile_image_url)
    `)
    .eq('id', id)
    .single()
